 ...
 */
public class ModalBottomBuyFragment extends BottomSheetDialogFragment {
    ...
    private Button btntambah,btnkurang,btnbeli;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_modal_bottom_buy, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        final EditText etjumlah = view.findViewById(R.id.integer_number);
        btntambah = view.findViewById(R.id.buttonincrease);
        btnkurang = view.findViewById(R.id.buttondecrease);
        btnbeli = view.findViewById(R.id.btninsertbuy);
